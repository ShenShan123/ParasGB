"""
批量运行对比实验脚本
支持的项目: change(6种模型), CircuitGCL, Cirgps, paragraph-simple
支持的任务: node_regression, node_classification, edge_regression, edge_classification

用法:
    python run_baselines.py                              # 运行所有(串行)
    python run_baselines.py --projects change_gcn        # 只运行 change_gcn
...
# ==================================================================================
# change_gcn 参数配置 (回归任务)
# ==================================================================================
CHANGE_GCN_REG_CONFIG = {
    "dir": "change",
    "script": "main.py",
    "model": "gcn",
    # 模型参数
...
# ==================================================================================
# change_gcn 参数配置 (分类任务)
# ==================================================================================
CHANGE_GCN_CLS_CONFIG = {
    "dir": "change",
    "script": "main.py",
    "model": "gcn",
    "edge_sample_rate": 0.6,
...
# ==================================================================================
# change_sage 参数配置 (回归任务)
# ==================================================================================
CHANGE_SAGE_REG_CONFIG = {
    "dir": "change",
    "script": "main.py",
    "model": "sage",
    "edge_sample_rate": 0.6,
...
# ==================================================================================
# change_sage 参数配置 (分类任务)
# ==================================================================================
CHANGE_SAGE_CLS_CONFIG = {
    "dir": "change",
    "script": "main.py",
    "model": "sage",
    "edge_sample_rate": 0.6,
...
# ==================================================================================
# change_gat 参数配置 (回归任务)
# ==================================================================================
CHANGE_GAT_REG_CONFIG = {
    "dir": "change",
    "script": "main.py",
    "model": "gat",
    "edge_sample_rate": 0.6,
...
# ==================================================================================
# change_gat 参数配置 (分类任务)
# ==================================================================================
CHANGE_GAT_CLS_CONFIG = {
    "dir": "change",
    "script": "main.py",
    "model": "gat",
    "edge_sample_rate": 0.6,
...
# ==================================================================================
# change_pna 参数配置 (回归任务)
# ==================================================================================
CHANGE_PNA_REG_CONFIG = {
    "dir": "change",
    "script": "main.py",
    "model": "pna",
    "edge_sample_rate": 0.6,
...
# ==================================================================================
# change_pna 参数配置 (分类任务)
# ==================================================================================
CHANGE_PNA_CLS_CONFIG = {
    "dir": "change",
    "script": "main.py",
    "model": "pna",
    "edge_sample_rate": 0.6,
...
# ==================================================================================
# change_sgformer 参数配置 (回归任务)
# ==================================================================================
CHANGE_SGFORMER_REG_CONFIG = {
    "dir": "change",
    "script": "main.py",
    "model": "sgformer",
    "edge_sample_rate": 0.6,
...
# ==================================================================================
# change_sgformer 参数配置 (分类任务)
# ==================================================================================
CHANGE_SGFORMER_CLS_CONFIG = {
    "dir": "change",
    "script": "main.py",
    "model": "sgformer",
    "edge_sample_rate": 0.6,
...
# ==================================================================================
# change_polynormer 参数配置 (回归任务)
# ==================================================================================
CHANGE_POLYNORMER_REG_CONFIG = {
    "dir": "change",
    "script": "main.py",
    "model": "polynormer",
    "edge_sample_rate": 0.6,
...
# ==================================================================================
# change_polynormer 参数配置 (分类任务)
# ==================================================================================
CHANGE_POLYNORMER_CLS_CONFIG = {
    "dir": "change",
    "script": "main.py",
    "model": "polynormer",
    "edge_sample_rate": 0.6,
...
def build_change_cmd(task: str, cfg: dict, gpu: int = None) -> str:
    """构建 change 项目的命令"""
...
PROJECT_CONFIGS = {
    # change 的 6 种模型 - 回归
    "change_gcn_reg": ("change", CHANGE_GCN_REG_CONFIG),
    "change_sage_reg": ("change", CHANGE_SAGE_REG_CONFIG),
    "change_gat_reg": ("change", CHANGE_GAT_REG_CONFIG),
    "change_pna_reg": ("change", CHANGE_PNA_REG_CONFIG),
    "change_sgformer_reg": ("change", CHANGE_SGFORMER_REG_CONFIG),
    "change_polynormer_reg": ("change", CHANGE_POLYNORMER_REG_CONFIG),
    # change 的 6 种模型 - 分类
    "change_gcn_cls": ("change", CHANGE_GCN_CLS_CONFIG),
    "change_sage_cls": ("change", CHANGE_SAGE_CLS_CONFIG),
    "change_gat_cls": ("change", CHANGE_GAT_CLS_CONFIG),
    "change_pna_cls": ("change", CHANGE_PNA_CLS_CONFIG),
    "change_sgformer_cls": ("change", CHANGE_SGFORMER_CLS_CONFIG),
    "change_polynormer_cls": ("change", CHANGE_POLYNORMER_CLS_CONFIG),
    # 其他项目
...
def get_change_config(project: str, task: str):
    """根据项目名和任务类型获取 change 配置"""
    # 从 project 中提取模型名 (如 change_gcn -> gcn)
    model_name = project.replace("change_", "")
    # 根据任务类型选择配置
    is_cls = "classification" in task
    config_key = f"change_{model_name}_{'cls' if is_cls else 'reg'}"
    return PROJECT_CONFIGS[config_key][1]


def build_cmd(project: str, task: str, gpu: int = None) -> str:
    """根据项目名构建命令"""
    if project.startswith("change_"):
        cfg = get_change_config(project, task)
        return build_change_cmd(task, cfg, gpu)
...
def main():
    ...
    # 验证项目名
    valid_projects = ["change_gcn", "change_sage", "change_gat", "change_pna", 
                      "change_sgformer", "change_polynormer", "circuitgcl", "cirgps", "paragraph"]
    for p in projects:
