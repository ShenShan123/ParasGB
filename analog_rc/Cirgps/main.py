...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_dataset", type=str, default="1+2+3+6+8+9+10+11+12+15+16+17+18", help="Training case IDs (e.g., '1+2+3+6+8+9+10+11+12+15+16+17+18').")
    parser.add_argument("--test_dataset", type=str, default="5+14+20", help="Test case IDs (e.g., '5+14+20').")
