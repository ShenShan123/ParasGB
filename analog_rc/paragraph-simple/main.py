...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_dataset", type=str, default="1+5+7+15+23+29+39+42+44+58+71+72+74", help="Name of training dataset (case IDs).")
    parser.add_argument("--test_dataset", type=str, default="11+55+78", help="Name of test dataset (case IDs).")
