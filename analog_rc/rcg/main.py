...
def parse_args():
    ...
    parser.add_argument("--train_cases", type=str, default="1+5+7+10+11+15+23+29+39+42+44+45+55+58+71+72+74+75+78", 
                        help="Case IDs for training (e.g., '17')")
    parser.add_argument("--test_cases", type=str, default="15+17+23", 
